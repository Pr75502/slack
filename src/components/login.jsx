  ...
  return (
    <div className="w-full space-y-6">
      <button 
        ...
        className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-slate-50 text-slate-900 font-bold py-3 px-4 rounded-xl border border-slate-200 shadow-sm active:scale-[0.98] transition-all duration-200"
      >
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase"><span className="bg-slate-900 px-2 text-slate-500 font-bold">Or continue with email</span></div>
      </div>
